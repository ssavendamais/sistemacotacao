    ...
    <div className="min-h-screen bg-white dark:bg-neutral-950 selection:bg-primary-100 dark:selection:bg-primary-900/50 selection:text-primary-900 dark:selection:text-primary-100 overflow-x-hidden transition-colors duration-300">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-neutral-950/80 backdrop-blur-md border-b border-neutral-100 dark:border-neutral-800 transition-colors duration-300">
        <nav className="flex items-center justify-between px-6 lg:px-12 py-4 max-w-7xl mx-auto w-full">
          <div className="flex items-center gap-2 group">
            <div className="h-10 w-10 rounded-xl bg-primary-500 text-white flex items-center justify-center shadow-lg shadow-primary-500/20 dark:shadow-primary-500/10 group-hover:scale-105 transition-all">
              <Zap className="h-6 w-6" />
            </div>
            <span className="text-2xl font-black text-neutral-900 dark:text-neutral-50 tracking-tighter">
              Venda Mais
            </span>
          </div>
      ...
      <section className="relative pt-40 pb-20 lg:pt-56 lg:pb-32 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          <h1 className="text-5xl lg:text-7xl font-black text-neutral-900 dark:text-neutral-50 tracking-tight leading-[1.1] mb-8 max-w-4xl animate-fade-in-up [animation-delay:100ms]">
            Conecte seu Mercado aos <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary-600 to-primary-400 dark:from-primary-400 dark:to-primary-300">Melhores Fornecedores</span>
          </h1>
          ...
          <div className="mt-20 pt-10 border-t border-neutral-100 dark:border-neutral-800/50 w-full animate-fade-in [animation-delay:500ms]">
             <p className="text-[10px] font-bold text-neutral-400 dark:text-neutral-500 uppercase tracking-[0.2em] mb-8">Utilizado por redes de destaque</p>
      ...
      <section className="py-24 bg-neutral-50/50 dark:bg-neutral-900/20 border-y border-neutral-100 dark:border-neutral-800/50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20 space-y-4">
             <h2 className="text-3xl lg:text-5xl font-black text-neutral-900 dark:text-neutral-50 tracking-tight">O que fazemos por você?</h2>
             <p className="text-neutral-500 dark:text-neutral-400 text-lg max-w-xl mx-auto font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={i} className="group border-none shadow-sm dark:shadow-none bg-white dark:bg-neutral-900 ring-1 ring-neutral-100 dark:ring-neutral-800 hover:shadow-xl hover:dark:ring-neutral-700 hover:-translate-y-2 transition-all duration-300">
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
           <div className="space-y-8">
              ...
              <div className="pt-4">
                 <Link href="/cadastro">
                   <Button variant="ghost" className="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-bold flex items-center gap-2 p-0 h-auto hover:bg-transparent dark:hover:bg-transparent">
           ...
           <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-primary-100 to-info-50 dark:from-primary-900/40 dark:to-info-900/40 rounded-[40px] rotate-3 relative overflow-hidden shadow-2xl dark:shadow-none dark:ring-1 dark:ring-neutral-800">
                 <div className="absolute inset-8 bg-white/50 dark:bg-neutral-900/50 backdrop-blur-xl rounded-[32px] border border-white/40 dark:border-neutral-700/50 p-8 flex flex-col justify-between shadow-inner dark:shadow-none">
      ...
      <section className="py-24 px-6 max-w-5xl mx-auto">
        <div className="bg-neutral-900 rounded-[48px] p-12 lg:p-20 text-center relative overflow-hidden dark:bg-neutral-900 dark:ring-1 dark:ring-neutral-800">
           ...
           <div className="relative z-10 space-y-8">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <Link href="/login" className="w-full sm:w-auto">
                   <Button variant="secondary" size="lg" className="w-full sm:w-auto px-12 h-16 text-neutral-900 dark:text-white border-2 border-white/10 dark:border-neutral-700 hover:bg-white/5 dark:hover:bg-neutral-800 font-bold bg-white/5 dark:bg-neutral-800/50">
                      Acessar minha conta
                   </Button>
                </Link>
              </div>
      ...
      <footer className="py-12 border-t border-neutral-100 dark:border-neutral-800/80 bg-white dark:bg-neutral-950 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-black text-neutral-900 dark:text-neutral-100 tracking-tighter">
              Venda Mais
            </span>
          </div>
